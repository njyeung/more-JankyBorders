...
struct settings g_settings = { .enabled = true,
                               .active_window = { .stype = COLOR_STYLE_GRADIENT,
                                                  .gradient = { .n_stops = 1,
                                                                .stops = {{ .color = 0xffe1e3e4 }} } },
                               .inactive_window = { .stype = COLOR_STYLE_GRADIENT,
                                                    .gradient = { .n_stops = 1,
                                                                  .stops = {{ .color = 0x00000000 }} } },
                               .background = { .stype = COLOR_STYLE_GRADIENT,
                                               .gradient = { .n_stops = 1,
                                                             .stops = {{ .color = 0x00000000 }} } },
                               .border_width = 4.f,
                               .blur_radius = 0,
